# Technical Details: Teradyne Nano 51e
...
|-----------|---------|--------|
| `operationTypeCode` | `30` | <!-- TODO: describe effect --> |
| `operator` | `sysoper` | <!-- TODO: describe effect --> |
| `sequenceVersion` | `` | <!-- TODO: describe effect --> |
| `sequenceFileName` | `` | <!-- TODO: describe effect --> |
| `revision` | `` | <!-- TODO: describe effect --> |
| `groupSteps` | `true` | <!-- TODO: describe effect --> |

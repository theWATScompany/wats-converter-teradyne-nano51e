...
This converter is written in C# using .NET Framework 4.7.2 in Visual Studio. It is important the WATS Client is not installed when running the project, as the installed API will be used instead of the installed NuGet package.
...
The converter should seek to be backwards compatible with older versions of itself. Usually this means names of parameters and their default values should not be changed.
